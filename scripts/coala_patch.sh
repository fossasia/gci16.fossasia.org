...
curl -X POST -H "Authorization: token $GITHUB_TOKEN" --data '{"title":"coala-fixes for build $TRAVIS_BUILD_NUMBER", "body":"Automated Coala fixes:$TRAVIS_BUILD_NUMBER", "head":"coala-autofix", "base":"master"}' https://api.github.com/repos/fossasia/gci16.fossasia.org/pulls
