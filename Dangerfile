...
markdown "Maintainers: @#{pr_author} did not provide a live :link:, one can be found at https://#{pr_author}.github.io/gci16.fossasia.org" unless github.pr_body.include? 'http'
