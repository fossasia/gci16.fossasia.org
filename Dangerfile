...
message "Maintainers: #{pr_author} did not provide a live link, one can be found at https://#{github.pr_author}.github.io/gci16.github.io" unless github.pr_body.include? 'http'
