...
# Check if a PR is mergeable and war if you have merge issues
can_merge = github.pr_json['mergeable']
warn('This PR appears to have merge errors. Please check CONTRIBUTING.md for help solving that.', sticky: false) unless can_merge
...
warn 'Please add your live link or a preview screenshot to the PR body.' unless github.pr_body.include? 'http'
